...
- Complete removal of live transcript system (Google Live, Gemini Semi-Live, Streaming Speech)
  ...
  - Removed all live transcript imports and references from Electron main process
  - Cleaned up TranscriptDetails.tsx component (removed hooks, state, and UI sections)
  - Fixed "Cannot find module" errors for deleted live transcript handlers
  - Restored clean foundation for future live transcript implementation
