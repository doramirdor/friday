...
const TranscriptDetails: React.FC<TranscriptDetailsProps> = ({ initialMeetingState }) => {
  ...
  const googleLiveTranscript = {
    ...
    latestResult: null,
    error: null,
    startRecording: (_options?: { languageCode: string; enableSpeakerDiarization: boolean; maxSpeakers: number; encoding: string; sampleRateHertz: number }) => {},
    stopRecording: () => {},
    clearTranscript: () => {}
  };
  ...
  const streamingSpeech = {
    ...
    isAvailable: false,
    error: null,
    startStreaming: (_options?: SemiLiveSpeechOptions) => {},
    stopStreaming: () => {},
    clearTranscript: () => {}
  };
  ...
  const GeminiSemiLiveTranscript = (_props: { maxSpeakers: number; onTranscriptAdd: (transcript: string) => void; className?: string }) => null;
